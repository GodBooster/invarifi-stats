...
const getPoolApy = async (masterchef, pool) => {
  ...
  const apy = compound(baseApy + simpleApy * shareAfterPerformanceFee, BASE_HPY, 1, 1);
  ...
  const apyBreakdown = {
    ...
    performanceFee,
    vaultApy: compound(simpleApy, BASE_HPY, 1, shareAfterPerformanceFee),
    lpFee: 0.001,
    tradingApr: baseApy,
    totalApy: compound(baseApy + simpleApy * shareAfterPerformanceFee, BASE_HPY, 1, 1),
  };
