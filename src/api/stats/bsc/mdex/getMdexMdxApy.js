...
const getMdexMdxApy = async () => {
  ...
  const shareAfterPerformanceFee = 1 - getTotalPerformanceFeeForVault('mdex-bsc-mdx');
  const apy = compound(simpleApy, process.env.BASE_HPY, 1, shareAfterPerformanceFee);
