...
const getFuseSingleApy = async () => {
  ...
  const performanceFee = getTotalPerformanceFeeForVault('fuse-fuse');
  const apy = compound(apr, BASE_HPY, 1, 1 - performanceFee);
...
module.exports = getFuseSingleApy;
