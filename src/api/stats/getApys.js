...
const { fromChainId, selectSupportedChains } = require('../../utils/chain');
...
const getApysArray = Object.values(
  selectSupportedChains({
    [fromChainId(ChainId.ethereum)]: getEthereumApys,
    [fromChainId(ChainId.polygon)]: getMaticApys,
    [fromChainId(ChainId.avax)]: getAvaxApys,
    [fromChainId(ChainId.fantom)]: getFantomApys,
    [fromChainId(ChainId.bsc)]: getBSCApys,
    [fromChainId(ChainId.one)]: getOneApys,
    [fromChainId(ChainId.arbitrum)]: getArbitrumApys,
    [fromChainId(ChainId.celo)]: getCeloApys,
    [fromChainId(ChainId.moonriver)]: getMoonriverApys,
    [fromChainId(ChainId.cronos)]: getCronosApys,
    [fromChainId(ChainId.aurora)]: getAuroraApys,
    [fromChainId(ChainId.fuse)]: getFuseApys,
    [fromChainId(ChainId.metis)]: getMetisApys,
    [fromChainId(ChainId.moonbeam)]: getMoonbeamApys,
    [fromChainId(ChainId.emerald)]: getEmeraldApys,
    [fromChainId(ChainId.optimism)]: getOptimismApys,
    [fromChainId(ChainId.kava)]: getKavaApys,
    [fromChainId(ChainId.canto)]: getCantoApys,
    [fromChainId(ChainId.zksync)]: getZksyncApys,
    [fromChainId(ChainId.zkevm)]: getZkevmApys,
    [fromChainId(ChainId.base)]: getBaseApys,
  })
);
...
const updateApys = async () => {
  ...
  try {
    const results = await Promise.allSettled(getApysArray.map(f => f()));
