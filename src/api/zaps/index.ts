import Koa from 'koa';
import { getZapSupportByVault, getZapSupportByVaultDebug, getZapsConfigs } from './zaps';
...
export async function zapsConfigs(ctx: Koa.Context) {
  const data = await getZapsConfigs();
